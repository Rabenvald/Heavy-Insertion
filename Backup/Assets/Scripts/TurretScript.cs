...
public class TurretScript : ImportantObject
{
	...
	void FixedUpdate () 
    {
        ...
        if (target != null)
        {
            ...
            targetRotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(TrackingComputer.GetParabolicFiringSolution(PitchComponet.transform.position, target.transform.position, ProjectileSpeed, Physics.gravity, transform.parent.rigidbody.velocity, target.rigidbody.velocity)), Time.deltaTime * SlerpRotationRate);
